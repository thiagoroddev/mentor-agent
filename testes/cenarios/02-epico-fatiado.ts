...
export function rodar(): Cenario {
  ...
  const reservaComEpico = ler(c, 'docs-mentor/tarefas/reserva.md')
  ...
  confere(c, !/\|\s+`TASK-RF-001`\s+\|/.test(ler(c, 'docs-mentor/tarefas/reserva.md')),
  ...
  const depois = ler(c, 'docs-mentor/tarefas/backlog.md')
