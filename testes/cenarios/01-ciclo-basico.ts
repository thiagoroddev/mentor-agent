...
export function rodar(): Cenario {
  ...
  mentor(c, 'init')
  escrever(c, 'docs-mentor/requisitos/requisitos.json', JSON.stringify([{
  ...
  const req = lerJson<Array<Record<string, any>>>(c, 'docs-mentor/requisitos/requisitos.json')[0]
  ...
  confere(c, ler(c, 'docs-mentor/requisitos/implementados.md').includes('RF-1'), 'a vista de implementados e gerada')
